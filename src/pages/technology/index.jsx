      ...
      <Layout>
        <section>
          <div className="container">
            ...
            <Filter searchNews={searchNews} title='Technology News' setCountry={setCountry} />
              <div className={styles.content}>
                {loading ? (
                  ...
                  data.map((el, inx) => (
                    <Link to={`/technology/${el.title.toLowerCase().split(' ').join('_')}`} className={styles.card} key={inx}>
